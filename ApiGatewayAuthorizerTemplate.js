...
exports.handler = function(event, context) {
  var params = {
    FunctionName: 'OAuth2JwtTokenVerifierServerless-dev-OAuth2JwtTokenVerifier', // the lambda function we are going to invoke
  ...
  lambda.invoke(params, function(err, claims) {
    if (err) {
      ...
      return context.fail('Unauthorized');
        ...
        var sub = JSON.parse(claims.Payload).sub;
        var scope = JSON.parse(claims.Payload).scope;
		...
		/*
			TODO: Build your Policy for Authorization
			example:
